...
export const register = async (req, res, next) => {
  try {
    ...
    const user = await User.create({
      ...
      email,
      password,
      emailVerified: isDevMode, // Auto-verify in development
      emailVerificationToken: isDevMode ? undefined : hashToken(verificationToken),
      emailVerificationExpires: isDevMode ? undefined : new Date(Date.now() + 24 * 60 * 60 * 1000), // 24 hours
    });
