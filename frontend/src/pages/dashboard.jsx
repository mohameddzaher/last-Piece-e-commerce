                      ...
                      {orders.slice(0, 3).map((order) => (
                        ...
                        >
                          ...
                          <div className='text-right'>
                            <p className='font-medium text-white'>${order.totals?.total?.toFixed(2)}</p>
                            <span className={`inline-block px-2 py-0.5 rounded text-xs capitalize ${getStatusColor(order.status)}`}>
                              {order.status}
                            </span>
                          </div>
                        </div>
            ...
            {activeTab === 'orders' && (
              ...
              >
                ...
                {loading ? (
                  ...
                  <div className='text-center py-12'>
                    <FiPackage className='mx-auto text-gray-600 mb-3' size={48} />
                    ...
                    {orders.map((order) => (
                      ...
                      >
                        <div className='flex items-center justify-between mb-3'>
                          ...
                          <span className={`px-3 py-1 rounded-lg text-sm capitalize ${getStatusColor(order.status)}`}>
                            {order.status}
                          </span>
                        </div>
                        <div className='flex items-center justify-between'>
                          ...
                          <p className='font-bold text-white'>${order.totals?.total?.toFixed(2)}</p>
                        </div>
                      </Link>
                    ))}
                  </div>
            ...
            {activeTab === 'cart' && (
              ...
              >
                ...
                {!cart?.items || cart.items.length === 0 ? (
                  <div className='text-center py-12'>
                    <FiShoppingCart className='mx-auto text-gray-600 mb-3' size={48} />
                        ...
                        <div className='flex items-center gap-2'>
                          <button
                            onClick={async () => {
                              if (item.quantity > 1) {
                                try {
                                  await cartAPI.updateQuantity(item.productId, item.quantity - 1);
