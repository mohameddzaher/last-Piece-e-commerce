    ...
    <div className='min-h-screen bg-slate-950'>
      <div className='max-w-5xl mx-auto px-4 py-8'>
        ...
        <div className='flex flex-wrap gap-2 mb-8'>
          {['all', 'pending', 'approved', 'in_transit', 'delivered', 'completed', 'cancelled'].map((status) => (
            <button
              key={status}
        ...
        {loading ? (
          ...
          <div className='text-center py-20'>
            ...
            <p className='text-gray-400 mb-6'>
              {filter === 'all' ? "When you place an order, it will appear here" : 'Try selecting a different filter'}
            </p>
            {filter === 'all' && (
              <Link
                href='/products'
                    ...
                    <div className='flex items-start justify-between gap-4'>
                      <div className='flex-1'>
                        <div className='flex items-center gap-3 mb-3'>
                          ...
                          <span className={`flex items-center gap-1.5 px-3 py-1 rounded-lg text-sm capitalize ${getStatusColor(order.status)}`}>
                            <StatusIcon size={14} />
                      ...
                      <div className='text-right flex items-center gap-4'>
                        <div>
                          <p className='text-xl font-bold text-white'>${order.totals?.total?.toFixed(2)}</p>
                        </div>
